...
const projects = [
  ...
  },
  {
    ...
    desc: [
      "This project was developed on the Automation/Controls team for Solidia Technologies. " +
      ...
      "I was a lead on this project for the Automation/Controls team. " +
      ...
      "I also configured the database and designed the HMI (Human Machine Interface) using MySQL, Python, and Ignition for the operator to easily monitor and control the systems. " +
